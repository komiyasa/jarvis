...
namespace TodoCognitive.Services
{
	public class FaceRecognitionService : IFaceRecognitionService, IDisposable
	{
        ...
        public Task<Jarvis.Models.Face[]> DetectAsync(Stream imageStream, bool returnFaceId, bool returnFaceLandmarks, IEnumerable<FaceAttributeType> returnFaceAttributes)
        {
